...
The data presented today is only a fraction of the work that we plan to do. Certain implementations will include:
\begin{itemize}
    ...
    \item \vspace*{-2mm} observation of the evolution from Wh>Cop interrogative clefts ('Quand c'est qu'il a appelé?') to Cop>Wh ('C'est quand qu'il a appelé?');
